			...
			>
				<el-table-column label="工作空间名称" show-overflow-tooltip>
					<template #default="scope">
						<SvgIcon :name="scope.row.xx " />
						<span class="ml10">{{ $t(scope.row.xx) }}</span>
					</template>
				</el-table-column>
				<el-table-column prop="xx" label="路由路径" show-overflow-tooltip></el-table-column>
				...
				<el-table-column label="类型" show-overflow-tooltip width="80">
					<template #default="scope">
						<el-tag type="success" size="small">{{ scope.row.xx }}工作空间</el-tag>
					</template>
				</el-table-column>
